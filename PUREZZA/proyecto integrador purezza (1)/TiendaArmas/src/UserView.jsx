...
const CarApp = () => {
  ...
  return (
    <div className="container my-4" style={{ backgroundColor: "" }}>
      <div
        style={{
          textAlign: "center",
          marginBottom: "20px",
      ...
      {loggedIn && currentSection === "inicio" && (
        <Description onViewAllProducts={handleViewAllProducts} />
      )}
      {loggedIn && currentSection === "regalos" && <Regalitos />}
      {loggedIn && currentSection === "contacto" && <Contacto />}
      {loggedIn && currentSection === "productos" && (
        <ProductsUser addToCart={addToCart} />
      )}
